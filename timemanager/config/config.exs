...
config :timemanager, TodolistWeb.Endpoint,
  ...
  live_view: [signing_salt: "bYMwOjO6"]
...
config :guardian, Todolist.Guardian,
  issuer: "TimeManager",
  secret_key: "9WeQEGACYKyYmYPlVH+wELW1uL5yySliVzLUEUjFj2s4aQf+ppN3G8yMLgBE/npo"

config :timemanager, Todolist.AuthPipeline,
  module: Todolist.Guardian,
  error_handler: Todolist.AuthError
